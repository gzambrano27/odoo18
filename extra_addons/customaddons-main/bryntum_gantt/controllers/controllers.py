...
class BryntumGantt(http.Controller):
    ...
    def default_fields(self):
        return [
            ...
            ("date_deadline", "deadlineDate", from_gantt_date),
    ...
    def bryntum_gantt_load(self, data=None, **kw):
        ...
        for project_id in project_ids:
            ...
            if project.bryntum_dont_load_domain:
                task_domain += ["!"]
                task_domain += safe_eval(project.bryntum_dont_load_domain)
            ...
            tasks = [
                {
                    ...
                    "expanded": True,
                    "deadlineDate": get_gantt_date(task.date_deadline, tz),
            ...
            projects = [
                {
                    ...
                    "taskStates": [
                        ...
                        for state in task_env._fields["kanban_state"].selection
                    ],
